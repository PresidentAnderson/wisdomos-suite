        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex items-center space-x-6">
              ...
              <Link href="/goals" className="text-black/70 hover:text-black">Goals</Link>
              <Link href="/contributions" className="text-black/70 hover:text-black">Contributions</Link>
              <Link href="/autobiography" className="text-black/70 hover:text-black">Autobiography</Link>
              <Link href="/assessments" className="text-black/70 hover:text-black">Assessments</Link>
              <Link href="/settings" className="text-black/70 hover:text-black">Settings</Link>
              <button
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 backdrop-blur-lg rounded-xl p-6 border border-cyan-500/30">
            ...
            <div className="text-3xl font-bold text-black mb-1">{stats.contributions}</div>
            <div className="text-gray-700">Contributions</div>
          </div>
          ...
          <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 backdrop-blur-lg rounded-xl p-6 border border-green-500/30">
            <div className="text-3xl mb-2">📚</div>
            <div className="text-3xl font-bold text-black mb-1">{stats.autobiographyYears}</div>
            <div className="text-gray-700">Years Documented</div>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-lg rounded-xl p-6 border border-purple-500/30">
            ...
            <div className="text-3xl font-bold text-black mb-1">{stats.boundariesHealthy}/13</div>
            <div className="text-gray-700">Healthy Boundaries</div>
          </div>
          ...
          <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 backdrop-blur-lg rounded-xl p-6 border border-yellow-500/30">
            <div className="text-3xl mb-2">✨</div>
            <div className="text-3xl font-bold text-black mb-1">{stats.totalEntries}</div>
            <div className="text-gray-700">Total Entries</div>
          </div>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link
              href="/goals"
              className="bg-gradient-to-r from-yellow-500 to-orange-500 text-black p-4 rounded-lg hover:from-yellow-600 hover:to-orange-600 transition-all text-center"
            >
            ...
            <Link
              href="/contributions"
              className="bg-gradient-to-r from-cyan-500 to-blue-500 text-black p-4 rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all text-center"
            >
              <div className="text-2xl mb-2">➕</div>
            ...
            <Link
              href="/autobiography"
              className="bg-gradient-to-r from-green-500 to-emerald-500 text-black p-4 rounded-lg hover:from-green-600 hover:to-emerald-600 transition-all text-center"
            >
              <div className="text-2xl mb-2">📝</div>
            ...
            <Link
              href="/assessments"
              className="bg-gradient-to-r from-purple-500 to-pink-500 text-black p-4 rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all text-center"
            >
        ...
        <div className="mt-8 bg-gradient-to-r from-indigo-500/20 to-purple-500/20 backdrop-blur-lg rounded-xl p-8 border border-indigo-500/30 text-center">
          <h2 className="text-3xl font-bold text-black mb-4">You Are Already Enough</h2>
