        ...
        {mockBadges.map((badge, index) => (
          ...
          >
              ...
              <div className="relative z-10">
                ...
                {!badge.unlocked && (
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Lock className="w-6 h-6 text-phoenix-ash" />
                  </div>
                )}
                ...
                <div className="absolute top-2 right-2">
                  {badge.rarity === 'legendary' && (
                    <Star className="w-4 h-4 text-phoenix-gold" />
                  )}
                  {badge.rarity === 'epic' && (
            ...
            {badge.unlocked && badge.id === 'boundary-guardian' && (
              <motion.div
                className="absolute -top-2 -right-2 bg-phoenix-orange text-white text-xs px-2 py-1 rounded-full font-semibold"
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
            ...
            >
              ...
              <div className="text-center mb-6">
                ...
                <h3 className={`text-2xl font-bold mb-2 ${
                  selectedBadge.unlocked ? 'flame-text' : 'text-gray-400'
                }`}>
                  {selectedBadge.name}
                </h3>
                ...
                <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-sm ${
                  selectedBadge.unlocked 
                    ...
                    : 'bg-phoenix-ash/30 text-gray-500'
                }`}>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className={selectedBadge.unlocked ? 'text-phoenix-gold' : 'text-gray-500'}>
              ...
              <div className="mt-6 text-center">
                {selectedBadge.unlocked ? (
                  <p className="text-phoenix-gold font-semibold">
